...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorHeight > 0) {
            ...
            Pair<Float, Float> lines = getIndicatorCoordinates();
            RectF oval3 = new RectF(lines.first+mTabPadding, height - mIndicatorHeight, lines.second-mTabPadding, height);// 设置个新的长方形
            canvas.drawRoundRect(oval3, 5, 5, mRectPaint);//第二个参数是x半径，第三个参数是y半径
        }
    }
