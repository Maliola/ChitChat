...
import com.jude.beam.view.NavigationBar;


public class NavigationBarShareActivity<T extends Presenter> extends BaseShareableActivity<T> implements NavigationBar.IProvideNavigationBar, OnClickListener {
