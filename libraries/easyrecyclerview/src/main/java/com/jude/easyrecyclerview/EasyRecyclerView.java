...
public class EasyRecyclerView extends FrameLayout {
    ...
    private void initView() {
        ...
        mPtrLayout = (CoolRefreshView) v.findViewById(R.id.ptr_layout);
    ...
    public void setRefreshListener(final android.support.v4.widget.SwipeRefreshLayout.OnRefreshListener listener) {
        ...
        mPtrLayout.addOnPullListener(new SimpleOnPullListener() {
            @Override
