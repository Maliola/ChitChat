...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public void setSelectPositon(int positon) {
        selectedItems.put(positon, true);
    }
...
//            throw new NullPointerException("You should invoking setLoadMore() first");
    ...
    private View createSpViewByType(ViewGroup parent, int viewType) {
        for (RecyclerArrayAdapter.ItemView headerView : headers) {
        ...
        for (RecyclerArrayAdapter.ItemView footerview : footers) {
    ...
    public final BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (view != null) {
            return new RecyclerArrayAdapter.StateViewHolder(view);
        }
